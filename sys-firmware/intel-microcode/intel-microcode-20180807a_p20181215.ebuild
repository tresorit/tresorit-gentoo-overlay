...
src_unpack() {
	cp `realpath ${DISTDIR}/microcode-${INTEL_SNAPSHOT}.tgz` .
	gunzip microcode-${INTEL_SNAPSHOT}.tgz
	unpack ./microcode-${INTEL_SNAPSHOT}.tar
	unpack intel-microcode-collection-${COLLECTION_SNAPSHOT}.tar.xz
}
